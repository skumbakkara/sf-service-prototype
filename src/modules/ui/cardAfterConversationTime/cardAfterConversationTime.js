...
const PULSE_INTERVAL_MS = 6200;

export default class CardAfterConversationTime extends LightningElement {
    filterGroups = FILTER_GROUPS;

    @track _totalSecs = 5 * 60 + 4;
    _interval = null;
    ...
    _tick() {
        ...
        this._totalSecs = Math.max(30, this._totalSecs + delta);
