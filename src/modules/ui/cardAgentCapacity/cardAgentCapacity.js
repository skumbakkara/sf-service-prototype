...
export default class CardAgentCapacity extends LightningElement {
    filterGroups = [
        {
    ...
    segments = [
        { id: 'used',      label: 'Used',      value: 75, colorVar: '--ccs-g-color-chart-category-light-color-1' },
        { id: 'available', label: 'Available',  value: 25, colorVar: '--ccs-g-color-chart-category-light-color-2' },
    ];
}
