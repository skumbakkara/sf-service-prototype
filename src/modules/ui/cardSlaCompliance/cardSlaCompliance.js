...
const PULSE_INTERVAL_MS = 5100;

export default class CardSlaCompliance extends LightningElement {
    filterGroups = FILTER_GROUPS;

    @track _pct = 94;
    _interval = null;

    get displayValue() { return `${this._pct}%`; }
    ...
    _tick() {
        ...
        this._pct = Math.min(100, Math.max(80, this._pct + delta));
