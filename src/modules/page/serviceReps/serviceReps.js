...
const REPS_DATA = [
    { id: 1,  name: 'Gilda Ann Thomas',  status: 'available-all',  statusLabel: 'Available for All',  statusTime: 'Since 9:02am',  hasFlag: true,  workSummary: '3 Cases 1 Message', channels: ['chat','call','cases'], login: '2m 5s',   state: '5m 3s',   capacityP: 100, capacityI: 100, accept: '3m 5s',   workload: '0/20', acw: '2m 4s',   queues: ['Billing','Chat','+3'],         skills: ['Billing','Refunds','+4'],            children: WORK_ITEMS },
    { id: 2,  name: 'Jerome Bell',        status: 'break',          statusLabel: 'On Break',           statusTime: 'Since 10:34am', hasFlag: false, workSummary: '2 Cases',           channels: ['call','cases'],       login: '10m 20s', state: '10m 20s', capacityP: 20,  capacityI: 35,  accept: '44m',     workload: '0/20', acw: '5m 34s',  queues: ['Sales','Returns','+2'],        skills: ['Sales','Spanish','+1'],              children: WORK_ITEMS.slice(0, 2) },
    { id: 3,  name: 'Devon Lane',         status: 'available-call', statusLabel: 'Available for Call', statusTime: 'Since 8:47am',  hasFlag: true,  workSummary: '3 Cases 1 Message', channels: ['chat','call','cases'], login: '2m 5s',   state: '5m 3s',   capacityP: 100, capacityI: 100, accept: '3m 5s',   workload: '0/20', acw: '2m 4s',   queues: ['Tech','Escalations','+4'],     skills: ['Technical','Tier 3','+3'],           children: WORK_ITEMS },
    { id: 4,  name: 'Arlene McCoy',       status: 'available-case', statusLabel: 'Available for Case', statusTime: 'Since 9:51am',  hasFlag: false, workSummary: '1 Case',            channels: ['call','cases'],       login: '8m 12s',  state: '14m 45s', capacityP: 100, capacityI: 40,  accept: '14m 45s', workload: '0/20', acw: '44m',     queues: ['VIP','Loyalty','+1'],          skills: ['Account Mgmt','French','+2'],        children: WORK_ITEMS.slice(0, 1) },
    { id: 5,  name: 'Floyd Miles',        status: 'available-all',  statusLabel: 'Available for All',  statusTime: 'Since 8:15am',  hasFlag: true,  workSummary: '3 Cases 1 Message', channels: ['chat','call','cases'], login: '2m 5s',   state: '5m 3s',   capacityP: 100, capacityI: 100, accept: '3m 5s',   workload: '0/20', acw: '2m 4s',   queues: ['Onboarding','Chat','+3'],      skills: ['Onboarding','Wireless','+3'],        children: WORK_ITEMS },
    { id: 6,  name: 'Savannah Nguyen',    status: 'available-case', statusLabel: 'Available for Case', statusTime: 'Since 10:08am', hasFlag: false, workSummary: '4 Cases',           channels: ['cases'],              login: '10m 20s', state: '1h 26m',  capacityP: 50,  capacityI: 100, accept: '5m 34s',  workload: '0/20', acw: '1h 26m',  queues: ['Cancellations','Tier 2','+2'], skills: ['Retention','Account Recovery','+2'], children: WORK_ITEMS },
    { id: 7,  name: 'Leslie Alexander',   status: 'break',          statusLabel: 'On Break',           statusTime: 'Since 11:22am', hasFlag: false, workSummary: '2 Messages',        channels: ['chat'],               login: '44m',     state: '8m 12s',  capacityP: 30,  capacityI: 50,  accept: '1h 26m',  workload: '0/20', acw: '10m 20s', queues: ['Chat','Support','+1'],         skills: ['Chat','Spanish','+2'],               children: WORK_ITEMS.slice(0, 2) },
    { id: 8,  name: 'Robert Fox',         status: 'available-call', statusLabel: 'Available for Call', statusTime: 'Since 7:38am',  hasFlag: false, workSummary: '3 Cases 1 Message', channels: ['chat','call','cases'], login: '5m 34s',  state: '10m 20s', capacityP: 50,  capacityI: 20,  accept: '7m 25s',  workload: '0/20', acw: '10m 20s', queues: ['Tier 1','Sales','+3'],         skills: ['Sales','Premium Support','+2'],      children: WORK_ITEMS },
    { id: 9,  name: 'Theresa Webb',       status: 'offline',        statusLabel: 'Offline',            statusTime: 'Since 6:55am',  hasFlag: false, workSummary: '1 Message',         channels: ['chat','call'],        login: '9m 02s',  state: '9m 02s',  capacityP: 30,  capacityI: 80,  accept: '14m 45s', workload: '0/20', acw: '5m 34s',  queues: ['Refunds','Billing','+1'],      skills: ['Refunds','Billing','+1'],            children: WORK_ITEMS.slice(0, 1) },
    { id: 10, name: 'Marvin McKinney',    status: 'available-all',  statusLabel: 'Available for All',  statusTime: 'Since 9:29am',  hasFlag: false, workSummary: '1 Call',            channels: ['call','cases'],       login: '1h 26m',  state: '5m 34s',  capacityP: 40,  capacityI: 50,  accept: '7m 25s',  workload: '0/20', acw: '44m',     queues: ['Tech','VIP','+2'],             skills: ['Technical','Tier 2','+2'],           children: WORK_ITEMS.slice(0, 1) },
    { id: 11, name: 'Kylie Jenner',       status: 'available-case', statusLabel: 'Available for Case', statusTime: 'Since 10:44am', hasFlag: false, workSummary: '1 Call',            channels: ['call','cases'],       login: '1h 26m',  state: '5m 34s',  capacityP: 40,  capacityI: 50,  accept: '7m 25s',  workload: '0/20', acw: '44m',     queues: ['Sales','Loyalty','+3'],        skills: ['Sales','German','+3'],               children: WORK_ITEMS.slice(0, 1) },
    { id: 12, name: 'Tom Hanks',          status: 'available-call', statusLabel: 'Available for Call', statusTime: 'Since 8:03am',  hasFlag: false, workSummary: '1 Call',            channels: ['call','cases'],       login: '1h 26m',  state: '5m 34s',  capacityP: 40,  capacityI: 50,  accept: '7m 25s',  workload: '0/20', acw: '44m',     queues: ['Escalations','Tier 3','+1'],   skills: ['Escalations','Account Mgmt','+1'],   children: WORK_ITEMS.slice(0, 1) },
    { id: 13, name: 'Eleanor Pena',       status: 'available-all',  statusLabel: 'Available for All',  statusTime: 'Since 8:42am',  hasFlag: false, workSummary: '2 Cases',           channels: ['chat','cases'],       login: '3h 12m',  state: '12m 04s', capacityP: 80,  capacityI: 60,  accept: '4m 18s',  workload: '0/20', acw: '6m 12s',  queues: ['Renewals','Loyalty','+2'],     skills: ['Retention','Account Mgmt','+2'],     children: WORK_ITEMS.slice(0, 2) },
    { id: 14, name: 'Wade Warren',        status: 'break',          statusLabel: 'On Break',           statusTime: 'Since 11:07am', hasFlag: false, workSummary: '1 Case',            channels: ['call'],               login: '4h 47m',  state: '15m 20s', capacityP: 0,   capacityI: 0,   accept: '—',       workload: '0/20', acw: '9m 02s',  queues: ['Tech','Tier 2','+1'],          skills: ['Technical','Diagnostics','+1'],      children: WORK_ITEMS.slice(2, 4) },
    { id: 15, name: 'Brooklyn Simmons',   status: 'available-all',  statusLabel: 'Available for All',  statusTime: 'Since 7:55am',  hasFlag: true,  workSummary: '4 Cases 2 Messages',channels: ['chat','call','cases'], login: '5h 03m',  state: '22m 47s', capacityP: 90,  capacityI: 100, accept: '2m 11s',  workload: '0/20', acw: '3m 18s',  queues: ['VIP','Billing','+3'],          skills: ['Premium Support','Billing','+3'],    children: WORK_ITEMS },
    ...
    { id: 17, name: 'Cody Fisher',        status: 'available-case', statusLabel: 'Available for Case', statusTime: 'Since 9:33am',  hasFlag: false, workSummary: '3 Cases',           channels: ['call','cases'],       login: '2h 58m',  state: '9m 12s',  capacityP: 70,  capacityI: 85,  accept: '5m 09s',  workload: '0/20', acw: '4m 33s',  queues: ['Sales','Onboarding','+2'],     skills: ['Sales','Onboarding','+2'],           children: WORK_ITEMS.slice(0, 3) },
    { id: 18, name: 'Cameron Williamson', status: 'available-all',  statusLabel: 'Available for All',  statusTime: 'Since 10:11am', hasFlag: false, workSummary: '1 Message',         channels: ['chat'],               login: '1h 44m',  state: '6m 50s',  capacityP: 100, capacityI: 75,  accept: '3m 02s',  workload: '0/20', acw: '2m 18s',  queues: ['Chat','Support','+1'],         skills: ['Chat','German','+1'],                children: WORK_ITEMS.slice(4, 5) },
    { id: 19, name: 'Jenny Wilson',       status: 'break',          statusLabel: 'On Break',           statusTime: 'Since 11:48am', hasFlag: false, workSummary: '2 Cases',           channels: ['cases'],              login: '5h 22m',  state: '20m 10s', capacityP: 0,   capacityI: 0,   accept: '—',       workload: '0/20', acw: '7m 41s',  queues: ['Refunds','Returns','+2'],      skills: ['Refunds','Returns','+1'],            children: WORK_ITEMS.slice(5, 7) },
    { id: 20, name: 'Esther Howard',      status: 'available-call', statusLabel: 'Available for Call', statusTime: 'Since 9:00am',  hasFlag: true,  workSummary: '5 Cases 1 Message', channels: ['chat','call','cases'], login: '4h 18m',  state: '14m 02s', capacityP: 100, capacityI: 90,  accept: '1m 47s',  workload: '0/20', acw: '5m 50s',  queues: ['Escalations','VIP','+3'],      skills: ['Escalations','Premium','+3'],        children: WORK_ITEMS },
    ...
    { id: 22, name: 'Bessie Cooper',      status: 'available-all',  statusLabel: 'Available for All',  statusTime: 'Since 8:17am',  hasFlag: false, workSummary: '2 Cases 1 Call',    channels: ['call','cases'],       login: '3h 50m',  state: '11m 17s', capacityP: 60,  capacityI: 70,  accept: '4m 22s',  workload: '0/20', acw: '6m 04s',  queues: ['Cancellations','Tier 2','+1'], skills: ['Retention','Negotiation','+1'],      children: WORK_ITEMS.slice(0, 2) },
    { id: 23, name: 'Albert Flores',      status: 'available-case', statusLabel: 'Available for Case', statusTime: 'Since 9:58am',  hasFlag: false, workSummary: '1 Case',            channels: ['cases'],              login: '2h 22m',  state: '7m 33s',  capacityP: 50,  capacityI: 100, accept: '6m 11s',  workload: '0/20', acw: '8m 25s',  queues: ['Tech','Diagnostics','+1'],     skills: ['Technical','Tier 3','+2'],           children: WORK_ITEMS.slice(1, 2) },
    { id: 24, name: 'Ronald Richards',    status: 'break',          statusLabel: 'On Break',           statusTime: 'Since 10:52am', hasFlag: false, workSummary: '1 Message',         channels: ['chat','cases'],       login: '6h 02m',  state: '18m 09s', capacityP: 0,   capacityI: 0,   accept: '—',       workload: '0/20', acw: '4m 17s',  queues: ['Chat','Billing','+1'],         skills: ['Chat','Billing','+1'],               children: WORK_ITEMS.slice(2, 3) },
    { id: 25, name: 'Dianne Russell',     status: 'available-all',  statusLabel: 'Available for All',  statusTime: 'Since 7:30am',  hasFlag: false, workSummary: '3 Cases 1 Call',    channels: ['chat','call','cases'], login: '5h 11m',  state: '13m 44s', capacityP: 85,  capacityI: 95,  accept: '2m 33s',  workload: '0/20', acw: '3m 22s',  queues: ['VIP','Loyalty','+3'],          skills: ['Premium','French','+3'],             children: WORK_ITEMS.slice(0, 3) },
    { id: 26, name: 'Jacob Jones',        status: 'available-call', statusLabel: 'Available for Call', statusTime: 'Since 9:24am',  hasFlag: true,  workSummary: '2 Cases',           channels: ['call','cases'],       login: '3h 33m',  state: '10m 02s', capacityP: 75,  capacityI: 50,  accept: '3m 48s',  workload: '0/20', acw: '5m 11s',  queues: ['Escalations','Tier 3','+2'],   skills: ['Escalations','Diagnostics','+2'],    children: WORK_ITEMS.slice(5, 7) },
    { id: 27, name: 'Annette Black',      status: 'available-case', statusLabel: 'Available for Case', statusTime: 'Since 8:53am',  hasFlag: false, workSummary: '1 Message',         channels: ['chat'],               login: '2h 41m',  state: '5m 28s',  capacityP: 100, capacityI: 65,  accept: '4m 01s',  workload: '0/20', acw: '2m 47s',  queues: ['Chat','Support'],              skills: ['Chat','Spanish','+1'],               children: WORK_ITEMS.slice(3, 4) },
    ...
    { id: 29, name: 'Darlene Robertson',  status: 'available-all',  statusLabel: 'Available for All',  statusTime: 'Since 9:06am',  hasFlag: false, workSummary: '4 Cases 2 Messages',channels: ['chat','call','cases'], login: '4h 27m',  state: '16m 50s', capacityP: 95,  capacityI: 80,  accept: '2m 18s',  workload: '0/20', acw: '4m 09s',  queues: ['Onboarding','VIP','+3'],       skills: ['Onboarding','Premium','+3'],         children: WORK_ITEMS },
    { id: 30, name: 'Ralph Edwards',      status: 'break',          statusLabel: 'On Break',           statusTime: 'Since 11:19am', hasFlag: false, workSummary: '1 Case',            channels: ['cases'],              login: '7h 14m',  state: '25m 11s', capacityP: 0,   capacityI: 0,   accept: '—',       workload: '0/20', acw: '11m 47s', queues: ['Returns','Refunds','+1'],      skills: ['Returns','Refunds','+1'],            children: WORK_ITEMS.slice(7, 8) },
    { id: 31, name: 'Jane Cooper',        status: 'available-call', statusLabel: 'Available for Call', statusTime: 'Since 8:25am',  hasFlag: false, workSummary: '3 Cases 1 Call',    channels: ['call','cases'],       login: '5h 49m',  state: '8m 17s',  capacityP: 65,  capacityI: 100, accept: '5m 03s',  workload: '0/20', acw: '6m 38s',  queues: ['Sales','Loyalty','+2'],        skills: ['Sales','Italian','+2'],              children: WORK_ITEMS.slice(0, 3) },
    { id: 32, name: 'Pamela Howard',      status: 'available-all',  statusLabel: 'Available for All',  statusTime: 'Since 9:41am',  hasFlag: true,  workSummary: '2 Cases',           channels: ['chat','cases'],       login: '2h 06m',  state: '9m 45s',  capacityP: 100, capacityI: 100, accept: '1m 58s',  workload: '0/20', acw: '3m 03s',  queues: ['Escalations','VIP','+2'],      skills: ['Escalations','Premium','+2'],        children: WORK_ITEMS.slice(0, 2) },
].map((rep) => ({
